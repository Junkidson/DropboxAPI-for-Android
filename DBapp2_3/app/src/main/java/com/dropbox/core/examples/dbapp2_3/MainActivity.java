...
public class MainActivity extends AppCompatActivity {
    ...
    Timer timer_Send = null;//メール送信用

    private final String HUBDATA_DIR = "/HUBDATA/";
    private final String COMMAND_DIR = "/Command from HS/";

    public static String down_preF = null;
    public static String down_curF = null;

    static String Post_Zip = "/storage/sdcard0/Postbox_to_HS_Zip/";
    static String Directory = "/storage/sdcard0/Postbox_to_HS/";//Zip化するディレクトリ
    static String path_Command = "/storage/sdcard0/Postbox_to_Command/";//Command一時保存用のpath
    static String path_AVHI = "/storage/sdcard0/Postbox_to_AVHI/";	//AVHIへのコマンドのpath
    static String path_WSN = "/storage/sdcard0/Postbox_to_WSN/";		//WSNへのコマンドのpath
